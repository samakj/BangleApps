...
Double-touching the screen can be used to manually switch between music and clock info modes.

## Development

This clock is written completely using typescript, so don't edit the js filed directly or else the changes will be overwritted the next time anyone builds the project.
